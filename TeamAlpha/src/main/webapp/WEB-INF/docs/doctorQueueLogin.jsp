...
<body
	style="background: url(https://www.tgh.org/sites/default/files/physician-finder-banner-photo.png); background-repeat: no-repeat; background-size: cover;">
	...
	<script>
		function submitForm() {
			...
			$("#loginForm").attr("action", "/TeamAlpha/doctorQueueHome")
					.submit();
			}
		}
		...
		function sendVerificationCode() {
			...
			$("#loginForm").attr("action", "/TeamAlpha/getSmsVerificationCode")
					.submit();
			}
		}
	</script>
