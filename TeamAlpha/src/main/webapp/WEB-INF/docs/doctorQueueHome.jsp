...
<script>
	...
	function logout() {
		$("#homeForm").attr("action", "/TeamAlpha/logout").submit();
	}

	function changeAlertStatus() {
		$("#homeForm").attr("action", "/TeamAlpha/changeAlertStatus").submit();
	}
	...
	function joinUserQueue() {
		if (!$('[name="queueReason"]').val().trim()) {
			...
			$("#homeForm").attr("action", "/TeamAlpha/joinQueue").submit();
		}
	}
</script>
			...
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand " id="userNameDisplay"
						style="color: lightblue">Welcome ${phoneNumber}</a>
				</div>
